...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapSingleStorie() {
    Get.toNamed(AppRoutes.singleStorieScreen);
  }
  ...
  onTapSingleVideo() {
    Get.toNamed(AppRoutes.singleVideoScreen);
  }
  ...
  onTapSingleEvent() {
    Get.toNamed(AppRoutes.singleEventScreen);
  }
  ...
  onTapNewPost() {
    Get.toNamed(AppRoutes.newPostScreen);
  }
  ...
  onTapVideoChat() {
    Get.toNamed(AppRoutes.videoChatScreen);
  }
