...
import 'package:init_s_application8/core/app_export.dart';
import 'package:init_s_application8/widgets/custom_icon_button.dart';
import 'package:init_s_application8/widgets/custom_text_form_field.dart';
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                          ...
                                                                          child: Row(
                                                                              ...
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                Text("lbl_gunther_ackner".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterBold14Gray900.copyWith(height: 1.00)),
                                                                                Padding(padding: getPadding(top: 1, bottom: 1), child: Text("lbl_4min".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterRegular12.copyWith(height: 1.00)))
                                                                              ])),
                                                                      Container(
                                                                          width: getHorizontalSize(
                                                                              220.00),
                                                                          ...
                                                                          child: Row(
                                                                              ...
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(8.00)), child: CommonImageView(imagePath: ImageConstant.imgPhoto2, height: getSize(68.00), width: getSize(68.00))),
                                                                                ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(8.00)), child: CommonImageView(imagePath: ImageConstant.imgImage16, height: getSize(68.00), width: getSize(68.00))),
                                                                                ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(8.00)), child: CommonImageView(imagePath: ImageConstant.imgPhoto, height: getSize(68.00), width: getSize(68.00)))
                                                                              ]))
                                                                    ]))
                                                          ])),
                                                  Padding(
